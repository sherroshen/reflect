...
public class DyProxyDemo01 {
	...
	public static void main(String[] args) {
		...
		IService s2 = (IService) Proxy.newProxyInstance(s1.getClass().getClassLoader(), // classLoader
				s1.getClass().getInterfaces(), // 目标对象实现了哪些接口
				new WorkHandler(s1));// InvocationHandler(通过此对象添加扩展功能)

		IDao d2 = (IDao) Proxy.newProxyInstance(d1.getClass().getClassLoader(), d1.getClass().getInterfaces(),
				new WorkHandler(d1));
